...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Nhất free chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Nhất free", HidePremium = false, IntroText = "Nhất free⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Nhất free SCRIPT")
W:AddLabel("DiscordNhất free")
local Section = W:AddSection({
    Name = "Status"
})
